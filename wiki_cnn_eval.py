...
tf.flags.DEFINE_string("negative_data_file", "./labeled/wiki_negative", "Data source for the positive data.")
...
if FLAGS.eval_train:
    x_raw, y_test = df.load_data_and_labels(FLAGS.positive_data_file, FLAGS.negative_data_file)
    y_test = np.argmax(y_test, axis=1)
else:
    total_num, x_raw = test_file_loader('./test/cleaned.txt')
    print(total_num)
